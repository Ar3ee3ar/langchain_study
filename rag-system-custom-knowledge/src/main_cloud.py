...
os.environ['OPENAI_API_KEY'] = os.getenv("TYPHOON_API_KEY")
os.environ['LANGSMITH_TRACING'] = "true"
os.environ['LANGSMITH_API_KEY'] = os.getenv('LANGSMITH_API_KEY')


class RAGPipeline:
    def __init__(self, model_name: str = "typhoon-v2.1-12b-instruct", max_memory_gb: float = 3.0):
        self.setup_logging()
        ...
        self.llm = ChatOpenAI(base_url="https://api.opentyphoon.ai/v1",
